                    ...
                    <div className="footer-widget-area">
                        <div className="container">
                            <div className="foter-logo text-center">
                                <img src={process.env.PUBLIC_URL + "assets/img/logo-white.png"} alt="Medik" />
                            </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 order-2 order-lg-3">
                                    <div className="widget nav-widget">
                                        ...
                                        <ul>
                                            ...
                                            <li><Link to="#">Marketing Research</Link></li>
                                            <li><Link to="#">Health Monitoring</Link></li>
                                            <li><Link to="#">Managed Services</Link></li>
                                            <li><Link to="#">Health Solutions</Link></li>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-md-5">
                                    <p className="copyrigt-text text-center text-md-left">Copyright By@<Link to="#">Slidesigma</Link> - 2021
          </p>
                                </div>
