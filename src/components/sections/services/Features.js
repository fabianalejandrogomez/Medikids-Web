                        ...
                        <div className="col-lg-6 col-md-10">
                            <div className="feature-text pl-50">
                                <div className="section-title left-border mb-40">
                                    ...
                                    <h2>Dedicated Health Solutions with 25 Years Experience.</h2>
                                </div>
                                <p>Over the years, a wide range of developments and innovations in the Medical Health have led
                                to many new Health Firm and services being produced. Moreover, there is need for IT
