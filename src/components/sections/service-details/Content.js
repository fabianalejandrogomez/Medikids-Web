            ...
            <section className="service-details-wrap pt-150 pb-120">
                                ...
                                <div>
                                    <div className="details-text mb-50">
                                        <div className="section-title left-border mb-40">
                                            <span className="title-tag">Health consultancy</span>
                                            <h2>Dedicated Health Solutions with 25 Years Experience in this field.</h2>
                                        </div>
                                        <p className="mb-30">
              ...
              required changes in a business.</p>
                                                        <ul>
                                                            ...
                                                            <li><i className="fal fa-check" /> Health and management language</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-header">
                                                <Accordion.Toggle as={Button} variant="link" eventKey="0">
                                                    Under normal circumstances a fee for Health Consulting ?
